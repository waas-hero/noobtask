var NoobtaskWizard = (function($){
    ...
    function window_loaded(){
        ...
        $('.button-next').on( 'click', function(e) {
            var loading_button = noobtask_loading_button(this);
            if(!loading_button){
                return false;
            }
    ...
    function PluginManager(){
                ...
                if(typeof response.url != 'undefined'){
                    ...
                    if(response.hash == current_item_hash){
                        ...
                        jQuery.post(response.url, response, function(response2) {
                            process_current();
                            $current_node.find('span').text(response.message + noobtask_setup_params.verify_text);
                        }).fail(ajax_callback);
                    }
        ...
        function process_current(){
            if(current_item){
                ...
                jQuery.post(noobtask_setup_params.ajaxurl, {
                    action: 'noobtask_setup_plugins',
                    wpnonce: noobtask_setup_params.wpnonce,
                    slug: current_item
        ...
        function find_next(){
            ...
            var $li = $('.noobtask-wizard-plugins li');
            $li.each(function(){
        ...
        return {
            init: function(btn){
                $('.noobtask-wizard-plugins').addClass('installing');
                complete = function(){
                    loading_content();
    ...
    function ContentManager(){
        ...
        function find_next(){
            ...
            var $items = $('tr.noobtask_default_content');
            var $enabled_items = $('tr.noobtask_default_content input:checked');
            $items.each(function(){
                if (current_item == '' || do_next) {
        ...
        return {
            init: function(btn){
                $('.noobtask-setup-pages').addClass('installing');
                $('.noobtask-setup-pages').find('input').prop("disabled", true);
                complete = function(){
                    loading_content();
                    window.location.href=btn.href;
                };
    ...
    function renderMediaUploader() {
        ...
        file_frame.on( 'select', function() {
            ...
            jQuery('.noobtask-site-logo').attr('src',attachment.url);
    ...
    function noobtask_loading_button(btn){
        ...
        $button.addClass('noobtask_loading_button_current');
        ...
        return {
                ...
                $button.removeClass('noobtask_loading_button_current');
